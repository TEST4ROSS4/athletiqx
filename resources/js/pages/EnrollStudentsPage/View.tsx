...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'View Enrollment', href: '/student-course-sections' },
];
        ...
        <div className="max-w-lg mx-auto space-y-6">
          ...
          <div className="rounded-lg border border-gray-200 bg-white shadow-sm p-6 space-y-4">
            <div>
              ...
              <p className="text-base font-sans text-gray-800">{assignment.student?.name}</p>
            </div>
            <div>
              <p className="text-sm font-heading text-[#102d4e]">Email:</p>
              <p className="text-base font-sans text-gray-800">{assignment.student?.email}</p>
            </div>
            <div>
