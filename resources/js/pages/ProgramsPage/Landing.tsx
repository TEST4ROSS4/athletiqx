        ...
        <AppLayout>
            ...
            <div className="p-6">
                <div className="space-y-6">
                    {/* Header */}
                    <h1 className="flex items-center gap-2 text-3xl font-bold sm:text-4xl font-heading text-[#102d4e]">
                        🏋️ Training Programs Hub
                    </h1>

                    <div className="flex flex-col gap-4 sm:flex-row">
                        <Link href={route('programs.create')}>
                            <Button className="flex items-center gap-2 bg-[#102d4e] hover:bg-[#0d243d] focus:ring-2 focus:ring-[#102d4e] focus:outline-none">
                                <PlusCircle size={18} />
                                Create New Program
                            </Button>
                        </Link>
