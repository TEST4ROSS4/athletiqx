...
const breadcrumbs: BreadcrumbItem[] = [
  { title: 'View Team Member', href: '/student-sport-teams/landing' },
];
        ...
        <div className="w-full max-w-xl rounded-lg border border-gray-200 bg-white p-6 shadow-md">
          ...
          <div className="space-y-4 text-sm text-gray-700">
            ...
            <div className="flex justify-between">
              ...
              <span>{assignment.sportTeam?.name}</span>
            </div>
            <div className="flex justify-between">
              <span className="font-medium text-gray-600">Season:</span>
              <span>{assignment.sportTeam?.season}</span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="mt-6 text-center">
            <Link
              href={route('student-sport-teams.index', assignment.sportTeam?.id)}
