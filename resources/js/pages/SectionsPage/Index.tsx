...
export default function Index({
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Sections" />
            <div className="p-3">
                <h1 className="mb-4 text-2xl font-bold">Section Management</h1>
                    ...
                    <table className="w-full text-left text-sm text-gray-700">
                        ...
                        <tbody>
                            {sections.map((section) => (
                                <tr key={section.id} className="border-b odd:bg-white even:bg-gray-50">
                                    <td className="px-6 py-2 font-medium">{section.id}</td>
                                    <td className="px-6 py-2">{section.code}</td>
                                    <td className="px-6 py-2">{section.program}</td>
